...
//
//		setredraw( false )
//		IF dw_list.GetitemStatus(1, 0, Primary!) = DataModified! THEN
//			MessageBox("Debug: 新しいSQL", 0)
//			 // 行のデータに変更があった場合の処理
//		
//		ELSE
//		
...
//		dw_list.update()
		...
		l_rtn	= dw_list.update( true, false )
		if isnull( l_rtn ) then l_rtn = 999
		MessageBox("Debug:" + string( l_rtn ), 0)
		if l_rtn <> 1 then
...
integer taborder = 60
boolean bringtotop = true
string dataobject = "dmm_genka_baika_multi_tmp"
