$PBExportHeader$asv_animation.sru
$PBExportComments$アニメーションコントロールの始祖オブジェクト
forward
global type asv_animation from animation
end type
end forward
...
global asv_animation asv_animation
...
on asv_animation.create
end on

on asv_animation.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "animation", this )
end choose
end event
