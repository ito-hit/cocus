$PBExportHeader$asv_checkbox.sru
$PBExportComments$チェックボックスコントロールの始祖オブジェクト
forward
global type asv_checkbox from checkbox
end type
end forward
...
global asv_checkbox asv_checkbox
...
on asv_checkbox.create
end on

on asv_checkbox.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "checkbox", this )
end choose
end event
