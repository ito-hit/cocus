$PBExportHeader$asv_datepicker.sru
$PBExportComments$日付ピッカーコントロールの始祖オブジェクト
forward
global type asv_datepicker from datepicker
end type
end forward
...
global asv_datepicker asv_datepicker
...
on asv_datepicker.create
end on

on asv_datepicker.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "datepicker", this )
end choose
end event
