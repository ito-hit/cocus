$PBExportHeader$asv_dropdownlistbox.sru
$PBExportComments$ドロップダウンリストボックスコントロールの始祖オブジェクト
forward
global type asv_dropdownlistbox from dropdownlistbox
end type
end forward
...
global asv_dropdownlistbox asv_dropdownlistbox
...
on asv_dropdownlistbox.create
end on

on asv_dropdownlistbox.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "dropdownlistbox", this )
end choose
end event
