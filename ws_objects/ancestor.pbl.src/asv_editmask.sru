$PBExportHeader$asv_editmask.sru
$PBExportComments$エディットマスクコントロールの始祖オブジェクト
forward
global type asv_editmask from editmask
end type
end forward
...
global asv_editmask asv_editmask
...
on asv_editmask.create
end on

on asv_editmask.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "editmask", this )
end choose
end event
