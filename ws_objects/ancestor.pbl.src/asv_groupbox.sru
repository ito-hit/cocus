$PBExportHeader$asv_groupbox.sru
$PBExportComments$グループボックスコントロールの始祖オブジェクト
forward
global type asv_groupbox from groupbox
end type
end forward
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "groupbox", this )
end choose
end event
...
on asv_groupbox.create
end on

on asv_groupbox.destroy
end on
