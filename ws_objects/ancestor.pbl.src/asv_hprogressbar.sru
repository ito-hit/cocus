$PBExportHeader$asv_hprogressbar.sru
$PBExportComments$水平プログレスバーコントロールの始祖オブジェクト
forward
global type asv_hprogressbar from hprogressbar
end type
end forward
...
global asv_hprogressbar asv_hprogressbar
...
protected subroutine pgb_step (integer p_step)
...
protected subroutine pgb_step (integer p_step);choose case true
...
on asv_hprogressbar.create
end on

on asv_hprogressbar.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "hprogressbar", this )
end choose
end event
