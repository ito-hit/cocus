$PBExportHeader$asv_hscrollbar.sru
$PBExportComments$水平スクロールバーコントロールの始祖オブジェクト
forward
global type asv_hscrollbar from hscrollbar
end type
end forward
...
global asv_hscrollbar asv_hscrollbar
...
on asv_hscrollbar.create
end on

on asv_hscrollbar.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "hscrollbar", this )
end choose
end event
