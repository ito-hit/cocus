$PBExportHeader$asv_htrackbar.sru
$PBExportComments$水平トラックバーコントロールの始祖オブジェクト
forward
global type asv_htrackbar from htrackbar
end type
end forward
...
global asv_htrackbar asv_htrackbar
...
on asv_htrackbar.create
end on

on asv_htrackbar.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "htrackbar", this )
end choose
end event
