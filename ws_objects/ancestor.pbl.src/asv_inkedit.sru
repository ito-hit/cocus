$PBExportHeader$asv_inkedit.sru
$PBExportComments$インクエディットコントロールの始祖オブジェクト
forward
global type asv_inkedit from inkedit
end type
end forward
...
global asv_inkedit asv_inkedit
...
on asv_inkedit.create
end on

on asv_inkedit.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "inkedit", this )
end choose
end event
