$PBExportHeader$asv_inkpicture.sru
$PBExportComments$インクピクチャコントロールの始祖オブジェクト
forward
global type asv_inkpicture from inkpicture
end type
end forward
...
global asv_inkpicture asv_inkpicture
...
on asv_inkpicture.create
end on

on asv_inkpicture.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "inkpicture", this )
end choose
end event
