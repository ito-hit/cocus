$PBExportHeader$asv_listbox.sru
$PBExportComments$リストボックスコントロールの始祖オブジェクト
forward
global type asv_listbox from listbox
end type
end forward
...
global asv_listbox asv_listbox
...
on asv_listbox.create
end on

on asv_listbox.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "listbox", this )
end choose
end event
