$PBExportHeader$asv_listview.sru
$PBExportComments$リストビューコントロールの始祖オブジェクト
forward
global type asv_listview from listview
end type
end forward
...
global asv_listview asv_listview
...
on asv_listview.create
end on

on asv_listview.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "listview", this )
end choose
end event
