$PBExportHeader$asv_monthcalendar.sru
$PBExportComments$月表示カレンダーコントロールの始祖オブジェクト
forward
global type asv_monthcalendar from monthcalendar
end type
end forward
...
global asv_monthcalendar asv_monthcalendar
...
on asv_monthcalendar.create
end on

on asv_monthcalendar.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "monthcalendar", this )
end choose
end event
