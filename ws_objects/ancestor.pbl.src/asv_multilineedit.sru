$PBExportHeader$asv_multilineedit.sru
$PBExportComments$マルチラインエディットコントロールの始祖オブジェクト
forward
global type asv_multilineedit from multilineedit
end type
end forward
...
global asv_multilineedit asv_multilineedit
...
on asv_multilineedit.create
end on

on asv_multilineedit.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "multilineedit", this )
end choose
end event
