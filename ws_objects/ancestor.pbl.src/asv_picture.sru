$PBExportHeader$asv_picture.sru
$PBExportComments$ピクチャコントロールの始祖オブジェクト
forward
global type asv_picture from picture
end type
end forward
...
global asv_picture asv_picture
...
on asv_picture.create
end on

on asv_picture.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "picture", this )
end choose
end event
