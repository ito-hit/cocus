$PBExportHeader$asv_picturebutton.sru
$PBExportComments$ピクチャボタンコントロールの始祖オブジェクト
forward
global type asv_picturebutton from picturebutton
end type
end forward
...
global asv_picturebutton asv_picturebutton
...
on asv_picturebutton.create
end on

on asv_picturebutton.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "picturebutton", this )
end choose
end event
