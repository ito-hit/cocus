$PBExportHeader$asv_picturehyperlink.sru
$PBExportComments$ピクチャハイパーリンクコントロールの始祖オブジェクト
forward
global type asv_picturehyperlink from picturehyperlink
end type
end forward
...
global asv_picturehyperlink asv_picturehyperlink
...
on asv_picturehyperlink.create
end on

on asv_picturehyperlink.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "picturehyperlink", this )
end choose
end event
