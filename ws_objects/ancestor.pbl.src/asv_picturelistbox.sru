$PBExportHeader$asv_picturelistbox.sru
$PBExportComments$ピクチャリストボックスコントロールの始祖オブジェクト
forward
global type asv_picturelistbox from picturelistbox
end type
end forward
...
global asv_picturelistbox asv_picturelistbox
...
on asv_picturelistbox.create
end on

on asv_picturelistbox.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "picturelistbox", this )
end choose
end event
