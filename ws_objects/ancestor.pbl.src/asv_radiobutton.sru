$PBExportHeader$asv_radiobutton.sru
$PBExportComments$ラジオボタンコントロールの始祖オブジェクト
forward
global type asv_radiobutton from radiobutton
end type
end forward
...
global asv_radiobutton asv_radiobutton
...
on asv_radiobutton.create
end on

on asv_radiobutton.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "radiobutton", this )
end choose
end event
