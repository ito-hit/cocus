$PBExportHeader$asv_richtextedit.sru
$PBExportComments$リッチテキストエディットコントロールの始祖オブジェクト
forward
global type asv_richtextedit from richtextedit
end type
end forward
...
global asv_richtextedit asv_richtextedit
...
on asv_richtextedit.create
end on

on asv_richtextedit.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "richtextedit", this )
end choose
end event
