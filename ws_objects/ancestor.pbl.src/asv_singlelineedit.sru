$PBExportHeader$asv_singlelineedit.sru
$PBExportComments$シングルラインエディットコントロールの始祖オブジェクト
forward
global type asv_singlelineedit from singlelineedit
end type
end forward
...
global asv_singlelineedit asv_singlelineedit
...
on asv_singlelineedit.create
end on

on asv_singlelineedit.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "singlelineedit", this )
end choose
end event
