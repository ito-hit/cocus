$PBExportHeader$asv_statichyperlink.sru
$PBExportComments$スタディックハイパーリンクコントロールの始祖オブジェクト
forward
global type asv_statichyperlink from statichyperlink
end type
end forward
...
global asv_statichyperlink asv_statichyperlink
...
on asv_statichyperlink.create
end on

on asv_statichyperlink.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "statichyperlink", this )
end choose
end event
