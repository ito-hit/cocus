$PBExportHeader$asv_statictext.sru
$PBExportComments$スタティックテキストコントロールの始祖オブジェクト
forward
global type asv_statictext from statictext
end type
end forward
...
global asv_statictext asv_statictext
...
on asv_statictext.create
end on

on asv_statictext.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "statictext", this )
end choose
end event
