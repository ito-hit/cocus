$PBExportHeader$asv_treeview.sru
$PBExportComments$ツリービューコントロールの始祖オブジェクト
forward
global type asv_treeview from treeview
end type
end forward
...
global asv_treeview asv_treeview
...
on asv_treeview.create
end on

on asv_treeview.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "treeview", this )
end choose
end event
