$PBExportHeader$asv_vscrollbar.sru
$PBExportComments$垂直スクロールバーコントロールの始祖オブジェクト
forward
global type asv_vscrollbar from vscrollbar
end type
end forward
...
global asv_vscrollbar asv_vscrollbar
...
on asv_vscrollbar.create
end on

on asv_vscrollbar.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "vscrollbar", this )
end choose
end event
