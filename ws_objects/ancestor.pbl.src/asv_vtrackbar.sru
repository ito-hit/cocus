$PBExportHeader$asv_vtrackbar.sru
$PBExportComments$垂直トラックバーコントロールの始祖オブジェクト
forward
global type asv_vtrackbar from vtrackbar
end type
end forward
...
global asv_vtrackbar asv_vtrackbar
...
on asv_vtrackbar.create
end on

on asv_vtrackbar.destroy
end on
...
choose case source.classname()
	case "p_drag_size_adjust"
		w_size_adjust.event callback( "vtrackbar", this )
end choose
end event
