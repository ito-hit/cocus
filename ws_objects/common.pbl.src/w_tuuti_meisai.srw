$PBExportHeader$w_tuuti_meisai.srw
$PBExportComments$通知画面明細表示ウインドウ
forward
global type w_tuuti_meisai from aw_base_window
end type
type cb_close from sv_cb_close within w_tuuti_meisai
end type
type dw_list from ivo_datawindow within w_tuuti_meisai
end type
type ln_line from line within w_tuuti_meisai
end type
end forward
...
global w_tuuti_meisai w_tuuti_meisai
...
type uo_signal from aw_base_window`uo_signal within w_tuuti_meisai
end type

type st_date from aw_base_window`st_date within w_tuuti_meisai
boolean visible = false
end type

type st_user_mei from aw_base_window`st_user_mei within w_tuuti_meisai
boolean visible = false
end type

type uo_test_mode from aw_base_window`uo_test_mode within w_tuuti_meisai
end type

type p_size_adjust from aw_base_window`p_size_adjust within w_tuuti_meisai
boolean visible = false
end type

type st_title from aw_base_window`st_title within w_tuuti_meisai
boolean visible = false
end type

type st_title_upper from aw_base_window`st_title_upper within w_tuuti_meisai
boolean visible = false
end type

type st_upper from aw_base_window`st_upper within w_tuuti_meisai
boolean visible = false
end type
