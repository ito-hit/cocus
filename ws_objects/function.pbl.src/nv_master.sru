...
declare orafunc procedure for mmenu.chk( :p_tokui_code, :p_mise_code ) using cocos;
execute orafunc;
fetch orafunc into :l_ret;
close orafunc;
...
fnc.strg.of_append_line( l_sql, "       siyo_kanou_flg," )
fnc.strg.of_append_line( l_sql, "       param" )
fnc.strg.of_append_line( l_sql, fnc.strg.of_format( "  from table( mmenu.get( '{1}' ) )", p_window_id ) )
...
fnc.strg.of_append_line( l_sql, "       kousin_date,kousin_user_id,kousin_client_id,kousin_pg_id," )
fnc.strg.of_append_line( l_sql, "       haita_flg" )
fnc.strg.of_append_line( l_sql, fnc.strg.of_format( "  from table( mmenu.get_full( '{1}' ) )", p_window_id ) )
