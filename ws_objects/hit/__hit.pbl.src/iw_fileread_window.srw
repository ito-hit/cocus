...
if isnull( l_strow ) or l_strow = 0 then
	l_strow	= 1
end if
...
//	for l_row = l_strow to dw_list.rowcount()
//		i_str_fileread.ret[l_cnt].data01	= dw_list.object.data01[l_row]
//		i_str_fileread.ret[l_cnt].data02	= dw_list.object.data02[l_row]
//		i_str_fileread.ret[l_cnt].data03	= dw_list.object.data03[l_row]
//		i_str_fileread.ret[l_cnt].data04	= dw_list.object.data04[l_row]
//		i_str_fileread.ret[l_cnt].data05	= dw_list.object.data05[l_row]
//		i_str_fileread.ret[l_cnt].data06	= dw_list.object.data06[l_row]
//		i_str_fileread.ret[l_cnt].data07	= dw_list.object.data07[l_row]
//		i_str_fileread.ret[l_cnt].data08	= dw_list.object.data08[l_row]
//		i_str_fileread.ret[l_cnt].data09	= dw_list.object.data09[l_row]
//		i_str_fileread.ret[l_cnt].data10	= dw_list.object.data10[l_row]
//		i_str_fileread.ret[l_cnt].data11	= dw_list.object.data11[l_row]
//		i_str_fileread.ret[l_cnt].data12	= dw_list.object.data12[l_row]
//		i_str_fileread.ret[l_cnt].data13	= dw_list.object.data13[l_row]
//		i_str_fileread.ret[l_cnt].data14	= dw_list.object.data14[l_row]
//		i_str_fileread.ret[l_cnt].data15	= dw_list.object.data15[l_row]
//		i_str_fileread.ret[l_cnt].data16	= dw_list.object.data16[l_row]
//		i_str_fileread.ret[l_cnt].data17	= dw_list.object.data17[l_row]
//		i_str_fileread.ret[l_cnt].data18	= dw_list.object.data18[l_row]
//		i_str_fileread.ret[l_cnt].data19	= dw_list.object.data19[l_row]
//		i_str_fileread.ret[l_cnt].data20	= dw_list.object.data20[l_row]
//		l_cnt	= l_cnt + 1
//	next
