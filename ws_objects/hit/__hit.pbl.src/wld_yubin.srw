...
//				end if
	...
	for l_cnt = i_str_fileread.ret[1].startrow to i_dts.rowcount()
		...
		//dw_list.object.data_kbn[l_row] = integer(ddplb_data_kbn.of_get_code())
		choose case integer(ddplb_data_kbn.of_get_code())
			case 1
				dw_list.object.jis_code[l_row]		= long(i_dts.object.data01[l_cnt])	//JIS-Code
//				if len(trim(i_dts.object.data02[l_cnt])) = 5 then
//					dw_list.object.yubin_no_old[l_row]	= left(i_dts.object.data02[l_cnt],3) + "-" + right(i_dts.object.data02[l_cnt],2)	//(旧)郵便番号
//				else
//					dw_list.object.yubin_no_old[l_row]	= i_dts.object.data02[l_cnt]	//(旧)郵便番号
//				end if
				dw_list.object.yubin_no_old[l_row]	= i_dts.object.data02[l_cnt]	//(旧)郵便番号
				dw_list.object.yubin_no[l_row]		= left(i_dts.object.data03[l_cnt],3) + "-" + right(i_dts.object.data03[l_cnt],4)	//郵便番号
				dw_list.object.todofu_kana[l_row]	= lefta(i_dts.object.data04[l_cnt],7)	//都道府県名(カナ)
				dw_list.object.sikutyo_kana[l_row]	= lefta(i_dts.object.data05[l_cnt],20)	//市区町村名(カナ)
				dw_list.object.tyoiki_kana[l_row]	= lefta(i_dts.object.data06[l_cnt],20)	//町域名(カナ) > ※本来項目長76byte 現DB定義過少(20byte)のため強制カット
				dw_list.object.todofu_mei[l_row]	= lefta(i_dts.object.data07[l_cnt],8)	//都道府県名
				dw_list.object.sikutyo_mei[l_row]	= lefta(i_dts.object.data08[l_cnt],24)	//市区町村名
				dw_list.object.tyoiki_mei[l_row]	= lefta(i_dts.object.data09[l_cnt],80)	//町域名
				dw_list.object.tyome[l_row]			= ""	//小字名・丁目・番地
				dw_list.object.jigyosyo_mei[l_row]	= ""	//大口事業所名
				dw_list.object.full_mei[l_row]		= lefta((trim(i_dts.object.data07[l_cnt]) + trim(i_dts.object.data08[l_cnt]) + trim(i_dts.object.data09[l_cnt])),200)	//住所
				dw_list.object.kbn_1[l_row]			= integer(i_dts.object.data10[l_cnt])	//区分1
				dw_list.object.kbn_2[l_row]			= integer(i_dts.object.data11[l_cnt])	//区分2
				dw_list.object.kbn_3[l_row]			= integer(i_dts.object.data12[l_cnt])	//区分3
				dw_list.object.kbn_4[l_row]			= integer(i_dts.object.data13[l_cnt])	//区分1
				dw_list.object.kbn_5[l_row]			= integer(i_dts.object.data14[l_cnt])	//区分2
				dw_list.object.kbn_6[l_row]			= integer(i_dts.object.data15[l_cnt])	//区分3
			...
			case 2
				dw_list.object.jis_code[l_row]		= long(i_dts.object.data01[l_cnt])	//JIS-Code
				dw_list.object.yubin_no[l_row]		= left(i_dts.object.data08[l_cnt],3) + "-" + right(i_dts.object.data08[l_cnt],4)	//大口事業所個別番号
//				if len(trim(i_dts.object.data09[l_cnt])) = 5 then
//					dw_list.object.yubin_no_old[l_row]	= left(i_dts.object.data09[l_cnt],3) + "-" + right(i_dts.object.data09[l_cnt],2)	//(旧)郵便番号
//				else
//					dw_list.object.yubin_no_old[l_row]	= i_str_fileread.ret[l_cnt].data09	//(旧)郵便番号
//				end if
				dw_list.object.yubin_no_old[l_row]	= i_dts.object.data09[l_cnt]	//(旧)郵便番号
				...
				dw_list.object.todofu_mei[l_row]	= lefta(i_dts.object.data04[l_cnt],8)	//都道府県名
				dw_list.object.sikutyo_mei[l_row]	= lefta(i_dts.object.data05[l_cnt],24)	//市区町村名
				dw_list.object.tyoiki_mei[l_row]	= lefta(i_dts.object.data06[l_cnt],80)	//町域名
				dw_list.object.tyome[l_row]			= lefta(i_dts.object.data07[l_cnt],124)	//小字名・丁目・番地
				dw_list.object.jigyosyo_mei[l_row]	= lefta(i_dts.object.data03[l_cnt],160)	//大口事業所名
				dw_list.object.full_mei[l_row]		= lefta((trim(i_dts.object.data04[l_cnt]) + trim(i_dts.object.data05[l_cnt]) + trim(i_dts.object.data06[l_cnt]) + trim(i_dts.object.data07[l_cnt])),200)	//住所
				...
				dw_list.object.kbn_7[l_row]			= integer(i_dts.object.data11[l_cnt])	//区分7
				dw_list.object.kbn_8[l_row]			= integer(i_dts.object.data12[l_cnt])	//区分8
				dw_list.object.kbn_9[l_row]			= integer(i_dts.object.data13[l_cnt])	//区分9
