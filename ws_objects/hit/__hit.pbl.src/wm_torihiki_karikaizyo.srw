...
type uo_seikyu from cv_input_seikyu within wm_torihiki_karikaizyo
end type
end forward
...
choose case p_control
	case "callsection"
		uo_seikyu.enabled			= p_enabled
		uo_seikyu.sle_input.enabled	= p_enabled
		uo_tokui.enabled			= p_enabled
		uo_tokui.sle_input.enabled	= p_enabled
