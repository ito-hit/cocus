...
$PBExportComments$運送便着店アップロード登録
forward
...
for l_row = 1 to dw_list.rowcount()
	...
	l_jyusyo				= dw_list.object.jyusyo[l_row]	//住所
	
	l_tyakuten_code			= dw_list.object.tyakuten_code[l_row]	//着店コード
	l_tyakuten_code_tome	= dw_list.object.tyakuten_code_tome[l_row]	//着店コード(営業所止め)
	
	l_hanyo_1				= dw_list.object.hanyo_col_1[l_row]
	l_hanyo_2				= dw_list.object.hanyo_col_2[l_row]
	l_hanyo_3				= dw_list.object.hanyo_col_3[l_row]
	l_hanyo_4				= dw_list.object.hanyo_col_4[l_row]
	l_hanyo_5				= dw_list.object.hanyo_col_5[l_row]
...
//				end if
	...
	for l_cnt = i_str_fileread.ret[1].startrow to i_dts.rowcount()
		...
		choose case integer(ddplb_data_kbn.of_get_code())
			case 1	//福山通運
				dw_list.object.yubin_no[l_row]				= left(i_dts.object.data01[l_cnt],3) + "-" + right(i_dts.object.data01[l_cnt],4)	//郵便番号
				dw_list.object.jyusyo[l_row]				= lefta(i_dts.object.data03[l_cnt],80)	//住所
				dw_list.object.tyakuten_code[l_row]			= i_dts.object.data04[l_cnt]	//着店コード
				dw_list.object.tyakuten_code_tome[l_row]	= i_dts.object.data04[l_cnt]	//着店コード(営業所止め)
				dw_list.object.hanyo_col_1[l_row]			= ""	//汎用項目1
				dw_list.object.hanyo_col_2[l_row]			= ""	//汎用項目2
				dw_list.object.hanyo_col_3[l_row]			= ""	//汎用項目3
				dw_list.object.hanyo_col_4[l_row]			= ""	//汎用項目4
				dw_list.object.hanyo_col_5[l_row]			= ""	//汎用項目5
				
			case 2	//佐川急便
				dw_list.object.yubin_no[l_row]				= mid(i_dts.object.data01[l_cnt],1,3) + "-" + mid(i_dts.object.data01[l_cnt],4,4)	//郵便番号
				dw_list.object.jyusyo[l_row]				= lefta(trim(mida(i_dts.object.data01[l_cnt],18,10)) + trim(mida(i_dts.object.data01[l_cnt],28,24)) + trim(mida(i_dts.object.data01[l_cnt],52,40)) + trim(mida(i_dts.object.data01[l_cnt],92,40)),80)	//住所
				dw_list.object.tyakuten_code[l_row]			= mida(i_dts.object.data01[l_cnt],264,4) + "-" + mida(i_dts.object.data01[l_cnt],268,3)	//着店コード
				dw_list.object.tyakuten_code_tome[l_row]	= mida(i_dts.object.data01[l_cnt],264,4) + "-" + "999"	//着店コード(営業所止め)
				dw_list.object.hanyo_col_1[l_row]			= mida(i_dts.object.data01[l_cnt],253,5)	//汎用項目1(佐川:JIS5コード)
				dw_list.object.hanyo_col_2[l_row]			= mida(i_dts.object.data01[l_cnt],258,4)	//汎用項目2(佐川:精算店コード)
				dw_list.object.hanyo_col_3[l_row]			= mida(i_dts.object.data01[l_cnt],264,4)	//汎用項目3(佐川:営業店コード)
				dw_list.object.hanyo_col_4[l_row]			= ""	//汎用項目4
				dw_list.object.hanyo_col_5[l_row]			= ""	//汎用項目5
			
			case 10	//ヤマト運輸
				dw_list.object.yubin_no[l_row]				= mida(i_dts.object.data01[l_cnt],2,3) + "-" + mida(i_dts.object.data01[l_cnt],5,4)	//郵便番号
				dw_list.object.jyusyo[l_row]				= ""	//住所
				dw_list.object.tyakuten_code[l_row]			= mida(i_dts.object.data01[l_cnt],14,2) + "-" + mida(i_dts.object.data01[l_cnt],16,2) + "-" + mida(i_dts.object.data01[l_cnt],18,2)	//着店コード
				dw_list.object.tyakuten_code_tome[l_row]	= mida(i_dts.object.data01[l_cnt],14,2) + "-" + mida(i_dts.object.data01[l_cnt],16,2) + "-" + mida(i_dts.object.data01[l_cnt],18,2)	//着店コード(営業所止め)
				dw_list.object.hanyo_col_1[l_row]			= ""	//汎用項目1
				dw_list.object.hanyo_col_2[l_row]			= ""	//汎用項目2
				dw_list.object.hanyo_col_3[l_row]			= ""	//汎用項目3
				dw_list.object.hanyo_col_4[l_row]			= ""	//汎用項目4
