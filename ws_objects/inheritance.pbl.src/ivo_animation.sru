$PBExportHeader$ivo_animation.sru
$PBExportComments$アニメーションコントロールの先祖オブジェクト
forward
global type ivo_animation from asv_animation
end type
end forward

global type ivo_animation from asv_animation
end type
global ivo_animation ivo_animation
...
on ivo_animation.create
call super::create
end on

on ivo_animation.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "animation"
