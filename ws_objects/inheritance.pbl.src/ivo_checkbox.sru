$PBExportHeader$ivo_checkbox.sru
$PBExportComments$チェックボックスコントロールの先祖オブジェクト
forward
global type ivo_checkbox from asv_checkbox
end type
end forward
...
global ivo_checkbox ivo_checkbox
...
on ivo_checkbox.create
call super::create
end on

on ivo_checkbox.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "checkbox"
