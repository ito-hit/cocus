$PBExportHeader$ivo_datepicker.sru
$PBExportComments$日付ピッカーコントロールの先祖オブジェクト
forward
global type ivo_datepicker from asv_datepicker
end type
end forward
...
global ivo_datepicker ivo_datepicker
...
on ivo_datepicker.create
call super::create
end on

on ivo_datepicker.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "datepicker"
