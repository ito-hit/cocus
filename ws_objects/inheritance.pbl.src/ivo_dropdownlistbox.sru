$PBExportHeader$ivo_dropdownlistbox.sru
$PBExportComments$ドロップダウンリストボックスコントロールの先祖オブジェクト
forward
global type ivo_dropdownlistbox from asv_dropdownlistbox
end type
end forward
...
global ivo_dropdownlistbox ivo_dropdownlistbox
...
on ivo_dropdownlistbox.create
call super::create
end on

on ivo_dropdownlistbox.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "dropdownlistbox"
