$PBExportHeader$ivo_graph.sru
$PBExportComments$グラフコントロールの先祖オブジェクト
forward
global type ivo_graph from asv_graph
end type
end forward

global type ivo_graph from asv_graph
end type
global ivo_graph ivo_graph
...
event constructor;call super::constructor;object_type	= "graph"
...
on ivo_graph.create
call super::create
TitleDispAttr.FaceName="Meiryo UI"
