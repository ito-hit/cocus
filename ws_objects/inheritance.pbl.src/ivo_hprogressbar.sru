$PBExportHeader$ivo_hprogressbar.sru
$PBExportComments$水平プログレスバーコントロールの先祖オブジェクト
forward
global type ivo_hprogressbar from asv_hprogressbar
end type
end forward

global type ivo_hprogressbar from asv_hprogressbar
end type
global ivo_hprogressbar ivo_hprogressbar
...
on ivo_hprogressbar.create
call super::create
end on

on ivo_hprogressbar.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "hprogressbar"
