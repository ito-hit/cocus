$PBExportHeader$ivo_hscrollbar.sru
$PBExportComments$水平スクロールバーコントロールの先祖オブジェクト
forward
global type ivo_hscrollbar from asv_hscrollbar
end type
end forward

global type ivo_hscrollbar from asv_hscrollbar
end type
global ivo_hscrollbar ivo_hscrollbar
...
on ivo_hscrollbar.create
call super::create
end on

on ivo_hscrollbar.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "hscrollbar"
