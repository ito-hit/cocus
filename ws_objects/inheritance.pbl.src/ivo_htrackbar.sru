$PBExportHeader$ivo_htrackbar.sru
$PBExportComments$水平トラックバーコントロールの先祖オブジェクト
forward
global type ivo_htrackbar from asv_htrackbar
end type
end forward

global type ivo_htrackbar from asv_htrackbar
end type
global ivo_htrackbar ivo_htrackbar
...
on ivo_htrackbar.create
call super::create
end on

on ivo_htrackbar.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "htrackbar"
