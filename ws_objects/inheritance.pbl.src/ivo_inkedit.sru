$PBExportHeader$ivo_inkedit.sru
$PBExportComments$インクエディットコントロールの先祖オブジェクト
forward
global type ivo_inkedit from asv_inkedit
end type
end forward
...
global ivo_inkedit ivo_inkedit
...
on ivo_inkedit.create
call super::create
end on

on ivo_inkedit.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "inkedit"
