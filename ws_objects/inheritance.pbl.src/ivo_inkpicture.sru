$PBExportHeader$ivo_inkpicture.sru
$PBExportComments$インクピクチャコントロールの先祖オブジェクト
forward
global type ivo_inkpicture from asv_inkpicture
end type
end forward

global type ivo_inkpicture from asv_inkpicture
end type
global ivo_inkpicture ivo_inkpicture
...
on ivo_inkpicture.create
call super::create
end on

on ivo_inkpicture.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "inkpicture"
