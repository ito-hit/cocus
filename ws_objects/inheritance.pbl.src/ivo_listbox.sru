$PBExportHeader$ivo_listbox.sru
$PBExportComments$リストボックスコントロールの先祖オブジェクト
forward
global type ivo_listbox from asv_listbox
end type
end forward
...
global ivo_listbox ivo_listbox
...
on ivo_listbox.create
call super::create
end on

on ivo_listbox.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "listbox"
