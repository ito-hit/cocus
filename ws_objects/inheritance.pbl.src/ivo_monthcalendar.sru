$PBExportHeader$ivo_monthcalendar.sru
$PBExportComments$月表示カレンダーコントロールの先祖オブジェクト
forward
global type ivo_monthcalendar from asv_monthcalendar
end type
end forward
...
global ivo_monthcalendar ivo_monthcalendar
...
on ivo_monthcalendar.create
call super::create
end on

on ivo_monthcalendar.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "monthcalendar"
