$PBExportHeader$ivo_multilineedit.sru
$PBExportComments$マルチラインエディットコントロールの先祖オブジェクト
forward
global type ivo_multilineedit from asv_multilineedit
end type
end forward
...
global ivo_multilineedit ivo_multilineedit
...
event type boolean input_check();// 入力された内容のチェック //
return of_check()
...
on ivo_multilineedit.create
call super::create
end on

on ivo_multilineedit.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "multilineedit"
