$PBExportHeader$ivo_picture.sru
$PBExportComments$ピクチャコントロールの先祖オブジェクト
forward
global type ivo_picture from asv_picture
end type
end forward

global type ivo_picture from asv_picture
end type
global ivo_picture ivo_picture
...
on ivo_picture.create
call super::create
end on

on ivo_picture.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "picture"
