$PBExportHeader$ivo_picturebutton.sru
$PBExportComments$ピクチャボタンコントロールの先祖オブジェクト
forward
global type ivo_picturebutton from asv_picturebutton
end type
end forward
...
global ivo_picturebutton ivo_picturebutton
...
on ivo_picturebutton.create
call super::create
end on

on ivo_picturebutton.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "picturebutton"
