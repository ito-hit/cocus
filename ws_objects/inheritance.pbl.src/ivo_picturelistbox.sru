$PBExportHeader$ivo_picturelistbox.sru
$PBExportComments$ピクチャリストボックスコントロールの先祖オブジェクト
forward
global type ivo_picturelistbox from asv_picturelistbox
end type
end forward
...
global ivo_picturelistbox ivo_picturelistbox
...
on ivo_picturelistbox.create
call super::create
end on

on ivo_picturelistbox.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "picturelistbox"
