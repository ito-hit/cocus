$PBExportHeader$ivo_richtextedit.sru
$PBExportComments$リッチテキストエディットコントロールの先祖オブジェクト
forward
global type ivo_richtextedit from asv_richtextedit
end type
end forward
...
global ivo_richtextedit ivo_richtextedit
...
on ivo_richtextedit.create
call super::create
end on

on ivo_richtextedit.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "richtextedit"
