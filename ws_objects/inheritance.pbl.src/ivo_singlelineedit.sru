$PBExportHeader$ivo_singlelineedit.sru
$PBExportComments$シングルラインエディットコントロールの先祖オブジェクト
forward
global type ivo_singlelineedit from asv_singlelineedit
end type
end forward
...
global ivo_singlelineedit ivo_singlelineedit
...
on ivo_singlelineedit.create
call super::create
end on

on ivo_singlelineedit.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "singlelineedit"
