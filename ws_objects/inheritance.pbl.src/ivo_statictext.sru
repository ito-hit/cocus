$PBExportHeader$ivo_statictext.sru
$PBExportComments$スタティックテキストコントロールの先祖オブジェクト
forward
global type ivo_statictext from asv_statictext
end type
end forward
...
global ivo_statictext ivo_statictext
...
on ivo_statictext.create
call super::create
end on

on ivo_statictext.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "statictext"
