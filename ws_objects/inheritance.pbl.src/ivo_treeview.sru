$PBExportHeader$ivo_treeview.sru
$PBExportComments$ツリービューコントロールの先祖オブジェクト
forward
global type ivo_treeview from asv_treeview
end type
end forward
...
global ivo_treeview ivo_treeview
...
on ivo_treeview.create
call super::create
end on

on ivo_treeview.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "treeview"
