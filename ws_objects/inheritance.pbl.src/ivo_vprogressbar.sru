$PBExportHeader$ivo_vprogressbar.sru
$PBExportComments$垂直プログレスバーコントロールの先祖オブジェクト
forward
global type ivo_vprogressbar from asv_vprogressbar
end type
end forward

global type ivo_vprogressbar from asv_vprogressbar
end type
global ivo_vprogressbar ivo_vprogressbar
...
on ivo_vprogressbar.create
call super::create
end on

on ivo_vprogressbar.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "vprogressbar"
