$PBExportHeader$ivo_vscrollbar.sru
$PBExportComments$垂直スクロールバーコントロールの先祖オブジェクト
forward
global type ivo_vscrollbar from asv_vscrollbar
end type
end forward

global type ivo_vscrollbar from asv_vscrollbar
end type
global ivo_vscrollbar ivo_vscrollbar
...
on ivo_vscrollbar.create
call super::create
end on

on ivo_vscrollbar.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "vscrollbar"
