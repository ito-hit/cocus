$PBExportHeader$ivo_vtrackbar.sru
$PBExportComments$垂直トラックバーコントロールの先祖オブジェクト
forward
global type ivo_vtrackbar from asv_vtrackbar
end type
end forward

global type ivo_vtrackbar from asv_vtrackbar
end type
global ivo_vtrackbar ivo_vtrackbar
...
on ivo_vtrackbar.create
call super::create
end on

on ivo_vtrackbar.destroy
call super::destroy
end on
...
event constructor;call super::constructor;object_type	= "	vtrackbar"
