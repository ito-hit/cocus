...
//	boolean	meisyo_display_on				// チェックが入ったらkisyo,aida,kimatuを表示する
	...
	// 2024.10.27 H.Yamamoto Add Start リストに「未選択」追加
	// リストに「空欄」「すべて」追加
	boolean	enabled_null, enabled_none//, enabled_all
	// 2024.10.27 H.Yamamoto Add End
...
if l_ds.retrieve( ) > 0 then
	...
	elseif enabled_none then
		...
		nendo_mei[l_row]	= c_noselected_word
		this.additem( nendo_mei[l_row] )
	// 2024.10.07 H.Yamamoto Add End
	/*
...
if isnull( nendo_code[index] ) then
	...
	// 2024.10.07 H.Yamamoto Add Start 「すべて」などが選択された際に、期初年月日と期末年月日の表示を初期化する
	st_meisyo_kisyo.text	= ""
	st_meisyo_kimatu.text	= ""
	// 2024.10.07 H.Yamamoto Add End
