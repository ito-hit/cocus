$PBExportHeader$wsm_tuuti.srw
$PBExportComments$通知の確認画面
forward
global type wsm_tuuti from aw_base_window
end type
type dw_list from ivo_datawindow within wsm_tuuti
end type
type cb_select from ivo_commandbutton within wsm_tuuti
end type
type cb_kidoku from ivo_commandbutton within wsm_tuuti
end type
type cb_midoku from ivo_commandbutton within wsm_tuuti
end type
type cb_close from ivo_commandbutton within wsm_tuuti
end type
type ddplb_disp from ivo_dropdownpicturelistbox within wsm_tuuti
end type
type st_disp from ivo_statictext within wsm_tuuti
end type
type ddplb_level from sv_ddplb_meisyo within wsm_tuuti
end type
type ddplb_syubetu from sv_ddplb_meisyo within wsm_tuuti
end type
type uo_user from cv_input_user within wsm_tuuti
end type
type cb_reload from ivo_commandbutton within wsm_tuuti
end type
end forward
...
type uo_signal from aw_base_window`uo_signal within wsm_tuuti
end type

type st_date from aw_base_window`st_date within wsm_tuuti
boolean visible = false
end type

type st_user_mei from aw_base_window`st_user_mei within wsm_tuuti
end type

type uo_test_mode from aw_base_window`uo_test_mode within wsm_tuuti
end type

type p_size_adjust from aw_base_window`p_size_adjust within wsm_tuuti
end type

type st_title from aw_base_window`st_title within wsm_tuuti
end type

type st_title_upper from aw_base_window`st_title_upper within wsm_tuuti
end type

type st_upper from aw_base_window`st_upper within wsm_tuuti
end type
